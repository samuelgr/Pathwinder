...
namespace Pathwinder
{
    namespace Configuration
    {
        ...
        public:
            ...
            inline Section(std::initializer_list<std::pair<std::wstring, Name>> contents)
                : Section()
            {
            ...
            /// are of type Boolean.
            inline std::optional<std::vector<TBooleanValue>>
                ExtractBooleanValues(std::wstring_view name)
            {
            ...
            /// @return Vector of extracted values, if the name was successfully located and values
            /// are of type integer.
            inline std::optional<std::vector<TIntegerValue>>
                ExtractIntegerValues(std::wstring_view name)
            {
            ...
            /// @return Vector of extracted values, if the name was successfully located and values
            /// are of type string.
            inline std::optional<std::vector<TStringValue>>
                ExtractStringValues(std::wstring_view name)
            {
        ...
        public:
            ...
            /// @return `true` if the setting exists, `false` otherwise.
            inline bool
                SectionNamePairExists(std::wstring_view section, std::wstring_view name) const
            {
                auto sectionIterator = sections.find(section);
        ...
        using TConfigurationFileSectionLayout =
            std::map<std::wstring_view, EValueType, std::less<>>;
