...
namespace Pathwinder
{
    namespace Message
    {
        ...
        /// Messages below the configured minimum severity severity (i.e. above the integer value
        /// that represents this severity) are not output.
#ifdef _DEBUG
        ...
        /// Messages at this severity or lower will be skipped unless a non-interactive output mode
        /// is being used.
        static constexpr ESeverity kMaximumSeverityToRequireNonInteractiveOutput =
            ESeverity::Warning;
        ...
        /// @return `true` if a message of the specified severity should be output, `false`
        /// otherwise.
