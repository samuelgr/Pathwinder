...
namespace PathwinderTest
{
    ...
    /// Test cases are run in alphabetical order by name, irrespective of the order in which they
    /// are registered.
    class Harness
    {
    public:
    ...
    private:
        ...
        /// Internal implementation of running all tests whose names begin with the specified
        /// prefix.
        /// @param [in] prefixToMatch Prefix against which to compare test case names.
        /// @return Number of failing tests.
