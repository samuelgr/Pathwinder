...
namespace PathwinderTest
{
    ...
    TEST_CASE(FilesystemRule_GetOriginAndTargetDirectories)
    {
        ...
        {
            const std::wstring_view expectedOriginDirectoryFullPath =
                kDirectoryTestRecord.first.first;
            const std::wstring_view expectedOriginDirectoryName = kDirectoryTestRecord.first.second;
            const std::wstring_view expectedTargetDirectoryFullPath =
                kDirectoryTestRecord.second.first;
            const std::wstring_view expectedTargetDirectoryName =
            ...
            const std::wstring_view actualOriginDirectoryName =
                filesystemRule.GetOriginDirectoryName();
            ...
            const std::wstring_view actualTargetDirectoryName =
                filesystemRule.GetTargetDirectoryName();
    ...
    TEST_CASE(FilesystemRule_GetOriginAndTargetDirectoryParents)
    {
        ...
        for (const auto& kDirectoryTestRecord : kDirectoryTestRecords)
        {
            const std::wstring_view expectedOriginDirectoryParent =
                kDirectoryTestRecord.first.second;
            const std::wstring_view expectedTargetDirectoryParent =
                kDirectoryTestRecord.second.second;
        ...
        constexpr std::pair<std::wstring_view, FilesystemRule::EDirectoryCompareResult>
            kDirectoryTestRecords[] = {
                ...
                {L"D:\\AnotherDirectory",
                 FilesystemRule::EDirectoryCompareResult::CandidateIsParent},
                {L"d:", FilesystemRule::EDirectoryCompareResult::CandidateIsAncestor},
                {L"d:\\aNOTHeRdiRECTorY",
                 FilesystemRule::EDirectoryCompareResult::CandidateIsParent}};
