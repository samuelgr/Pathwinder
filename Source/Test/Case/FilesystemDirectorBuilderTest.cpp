...
namespace PathwinderTest
{
    ...
    TEST_CASE(FilesystemDirectorBuilder_AddRule_Success_OriginIsSubdir)
    {
        ...
        TEST_ASSERT(directorBuilder.AddRule(L"3", L"C:\\Level1\\Level2\\Level3", L"C:\\TargetDir3").HasValue());
    }
    ...
    // Verifies that rule creation fails if the origin directory is the same as another rule's origin or target directory.
    // This variation exercises case insensitivity by changing the case of the origin directory used in various situations.
    ...
    // Verifies that rule creation fails if the target directory is the same as another rule's origin directory.
    // This variation exercises case insensitivy by changing the case of the overlapping target directory.
    ...
    TEST_CASE(FilesystemDirectorBuilder_HasDirectory_Hierarchy)
    {
        ...
        TEST_ASSERT(directorBuilder.AddRule(L"1", L"C:\\Level1\\Level2\\Level3\\Level4\\Level5", L"C:\\Target1").HasValue());
    ...
    TEST_CASE(FilesystemDirectorBuilder_Build_Success_OriginHierarchy)
    {
        ...
        FilesystemDirectorBuilder directorBuilder;
        TEST_ASSERT(directorBuilder.AddRule(L"1", L"C:\\OriginBase\\OriginSubdir\\Subdir1\\Subdir2", L"C:\\TargetBase\\Target2").HasValue());
        TEST_ASSERT(directorBuilder.AddRule(L"2", L"C:\\OriginBase\\OriginSubdir\\Subdir1", L"C:\\TargetBase\\Target1").HasValue());
        TEST_ASSERT(directorBuilder.AddRule(L"3", L"C:\\OriginBase\\OriginSubdir", L"C:\\TargetBase\\TargetBase").HasValue());
    ...
    TEST_CASE(FilesystemDirectorBuilder_Build_Failure_OriginParentMissing)
    {
        ...
        FilesystemDirectorBuilder directorBuilder;
        TEST_ASSERT(directorBuilder.AddRule(L"1", L"C:\\OriginDir\\Subdir1", L"C:\\TargetDir\\Subdir1").HasValue());
