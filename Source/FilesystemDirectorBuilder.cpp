...
namespace Pathwinder
{
        ...
        Configuration::ConfigurationData& configData)
    {
                  ...
                  Strings::kStrConfigurationSectionFilesystemRulePrefix)));)
        {
            ...
            auto filesystemRuleSectionNameAndContents =
                configData.ExtractSection(filesystemRuleIter);
            ...
            Configuration::Section& filesystemRuleContents =
            ...
            {
                Message::Output(
                    Message::ESeverity::Error, addFilesystemRuleResult.Error().AsCString());
    ...
    bool FilesystemDirectorBuilder::IsValidDirectoryString(std::wstring_view candidateDirectory)
    {
        ...
        for (std::wstring_view pathComponent : Strings::Tokenizer(candidateDirectory, L"\\"))
        {
            ...
            for (wchar_t disallowedEntireComponentChar :
                 kDisallowedCharactersForEntirePathComponent)
            {
    ...
    ValueOrError<FilesystemDirector, TemporaryString> FilesystemDirectorBuilder::Build(void)
    {
        ...
        for (const auto& filesystemRuleRecord : filesystemRules)
        {
            ...
            const bool originIsDirectory = FilesystemOperations::IsDirectory(
                filesystemRule.GetOriginDirectoryFullPath().data());
        ...
        for (const auto& filesystemRuleRecord : filesystemRules)
        {
            ...
            {
                std::wstring_view conflictingFilesystemRuleName =
                    ancestorNode->GetData()->GetName();
                return Strings::FormatString(
