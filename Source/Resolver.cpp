...
namespace Pathwinder
{
    namespace Resolver
    {
        ...
        {
            static const std::unordered_map<std::wstring_view, TResolveReferenceFunc>
                kResolversByDomain = {
                    ...
                    {Strings::kStrReferenceDomainKnownFolderIdentifier,
                     &ResolveKnownFolderIdentifier}};
        ...
        )
        {
            ...
            for (size_t i = 1; i < strParts.Size(); i += 2)
            {
                ...
                else
                {
                    ...
                    {
                        for (const auto resolvedReferenceResultChar :
                             resolvedReferenceResult.Value())
                        {
